...
function About() {
    ...
    return(
        <div className='page1' style={{textAlign: 'center'}}>
             ...
             <h1>About me</h1>      <img src={logo} alt="logo" size="20px"/>
             <div className='divider' />
                
        
            </header>
            <p>Hello, I'm <span className='text-blue-500'>Nicolas Salcedo</span>, a passionate QA Automation Engineer with expertise in creating robust test frameworks and ensuring software quality.</p>
            ...
            <p>In addition to my technical skills, I am a strong advocate for Agile methodologies and continuous improvement in software development practices.</p> 
